...
function createHeader(message) {
    ...
    header.classList.add('absolute', 'top-20', 'w-full', 'p-5', 'flex', 'justify-end', 'items-center', 'bg-yellow-2', 'font-semibold', 'z-10', 'md:z-20');

    header.innerHTML = `
        <p class="absolute left-0 w-full px-10 text-center">${message}</p>
